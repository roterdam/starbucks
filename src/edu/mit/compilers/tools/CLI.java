...
public class CLI {
	 ...
	 * stop. CFG: produce an image of the control flow graph ASSEMBLY: produce
	 * assembly from the input.
	 */
	public enum Action {
		DEFAULT, SCAN, PARSE, INTER, LOWIR, CFG, ASSEMBLY
	};
	 ...
	 * <TT>lowir</TT> specifies Action.LOWIR <TT>cfg</TT> specifies Action.CFG
